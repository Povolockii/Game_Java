...
//Этот класс содержит логический массив текущих и предыдущих ключевых состояний
//для 10 ключей, которые используются для этой игры.
//а ключ загружается когда keyState[k] is true.
...
public class Keys {
	...
	public static void keySet(int i, boolean b) {
		...
		else if(i == KeyEvent.VK_W) keyState[UP1] = b;
